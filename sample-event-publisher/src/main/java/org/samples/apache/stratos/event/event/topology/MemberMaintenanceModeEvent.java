...
public class MemberMaintenanceModeEvent extends TopologyEvent implements SampleEventInterface {
    ...
    public void process() {
        ...
        org.apache.stratos.messaging.domain.topology.MemberStatus memberStatus =
                org.apache.stratos.messaging.domain.topology.MemberStatus.valueOf(status.name());
        memberMaintenanceModeEvent.setStatus(memberStatus);
        memberMaintenanceModeEvent.setProperties(properties);
        Utils.publishEvent(memberMaintenanceModeEvent);
    }
}

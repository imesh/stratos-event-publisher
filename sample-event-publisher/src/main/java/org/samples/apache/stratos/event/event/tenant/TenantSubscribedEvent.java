...
public class TenantSubscribedEvent extends TenantEvent implements SampleEventInterface {
    ...
    public void process() {
        org.apache.stratos.messaging.event.tenant.TenantSubscribedEvent
                ...
                new org.apache.stratos.messaging.event.tenant.TenantSubscribedEvent(tenantId, serviceName, clusterIds);
        Utils.publishEvent(tenantSubscribedEvent);
    }
}

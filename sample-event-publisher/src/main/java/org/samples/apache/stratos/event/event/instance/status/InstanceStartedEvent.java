...
/**
 * Model class for InstanceStartedEvent
 */
@XmlRootElement(name = "InstanceStartedEvent")
public class InstanceStartedEvent extends InstanceStatusEvent implements SampleEventInterface {
    ...
    public void process() {
        org.apache.stratos.messaging.event.instance.status.InstanceStartedEvent
                ...
                (applicationId, serviceName, clusterId, memberId, clusterInstanceId, networkPartitionId, partitionId);

        Utils.publishEvent(instanceStartedEvent);
    }
}

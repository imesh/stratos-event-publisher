...
/**
 * Health Stat Listerner
 */
public class HealthStatListener implements MessageListener {

    private static final Log log = LogFactory.getLog(HealthStatListener.class);

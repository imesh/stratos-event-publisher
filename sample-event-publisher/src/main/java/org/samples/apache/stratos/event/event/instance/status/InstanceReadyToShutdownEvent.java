...
public class InstanceReadyToShutdownEvent extends InstanceStatusEvent implements SampleEventInterface {
    ...
    public void process() {
        org.apache.stratos.messaging.event.instance.status.InstanceReadyToShutdownEvent
                ...
                new org.apache.stratos.messaging.event.instance.status.InstanceReadyToShutdownEvent(
                        serviceName, clusterId, memberId, clusterInstanceId, networkPartitionId, partitionId);
        instanceReadyToShutdownEvent.setGroupId(groupId);
        Utils.publishEvent(instanceReadyToShutdownEvent);
    }
}

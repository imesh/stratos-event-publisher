...
public class TenantUnSubscribedEvent extends TenantEvent implements SampleEventInterface {
    ...
    public void process() {
        org.apache.stratos.messaging.event.tenant.TenantUnSubscribedEvent
                ...
                new org.apache.stratos.messaging.event.tenant.TenantUnSubscribedEvent(tenantId, serviceName,
                        clusterIds);
        Utils.publishEvent(tenantUnSubscribedEvent);
    }
